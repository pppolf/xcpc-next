...
export default function ProblemInfoCard({ contestId, problemId, info, type = 'problem' }: ProblemInfoProps) {
  return (
    <div className="bg-white border border-gray-200 shadow-sm rounded-sm overflow-hidden w-full lg:w-72 shrink-0">
      ...
      <ul className="text-sm divide-y divide-gray-100 font-serif">
        ...
        <li className="px-4 py-3">
          ...
          <div className="font-bold text-gray-800 text-lg">{2 * info.timeLimit} / {info.timeLimit} MS</div>
        </li>
        <li className="px-4 py-3">
          <div className="text-gray-500 mb-1">Memory Limit (Java / Others)</div>
          <div className="font-bold text-gray-800 text-lg">{2 * info.memoryLimit} / {info.memoryLimit} K</div>
        </li>
        <li className="px-4 py-3 flex justify-between">
