  ...
  return (
    <div className="max-w-5xl mx-auto">
      ...
      <div className="bg-white shadow rounded-lg overflow-hidden">
        ...
        <ul>
          {contests.map((c) => (
            <li key={c.id} className="border-b last:border-0 px-6 py-4 flex justify-between items-center hover:bg-gray-50">
              <div>
              ...
              <div className="flex gap-3">
                 ...
                 <button className="text-sm text-gray-600 hover:text-gray-900 px-2">Settings</button>
              </div>
            </li>
          ))}
        </ul>
